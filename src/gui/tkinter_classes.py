...
class Menu(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        menu_toggle1 = tk.Checkbutton(toggle_frame, text="check 1")
        menu_toggle2 = tk.Checkbutton(toggle_frame, text="check 2")
...
class Entry(ttk.Frame):
    def __init__(self, parent, lbl_text, btn_txt, bg_color):
        super().__init__(parent)

        label = ttk.Label(self, text=lbl_text, background=bg_color)
        button = ttk.Button(self, text=btn_txt)
